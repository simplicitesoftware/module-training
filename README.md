...
`TrnSearchIndex` business object definition
-------------------------------------------
...
|--------------------------------------------------------------|------------------------------------------|----------|-----------|----------|----------------------------------------------------------------------------------|
| `trnTsiFilter`                                               | char(100)                                | yes*     | yes       |          | -                                                                                |
| `trnTsiDisplay`                                              | char(100)                                | yes      | yes       |          | -                                                                                |
| `trnTsiIcon`                                                 | image                                    |          | yes       |          | -                                                                                |
| `trnTsiMaterialIconsName`                                    | char(100)                                |          | yes       |          | -                                                                                |

`TrnSearchScript` business object definition
--------------------------------------------
...
| Name                                                         | Type                                     | Required | Updatable | Personal | Description                                                                      |
|--------------------------------------------------------------|------------------------------------------|----------|-----------|----------|----------------------------------------------------------------------------------|
| `trnSsTsiId` link to **`TrnSearchIndex`**                    | id                                       |          | yes       |          | -                                                                                |
| _Ref. `trnSsTsiId.trnTsiFilter`_                             | _char(100)_                              |          |           |          | -                                                                                |
...
`TrnVideo` business object definition
-------------------------------------
...
| `trnPageTrnLessonid` link to **`TrnLesson`**                 | id                                       | yes*     | yes       |          | -                                                                                |
| _Ref. `trnPageTrnLessonid.trnLsnPath`_                       | _text(400)_                              |          |           |          | -                                                                                |
| _Ref. `trnPageTrnLessonid.trnLsnFrontPath`_                  | _url(400)_                               |          |           |          | -                                                                                |
| _Ref. `trnPageTrnLessonid.trnLsnPublish`_                    | _boolean_                                |          |           |          | _Determines if the lesson is visible on the front-end application._              |
| _Ref. `trnPageTrnLessonid.trnLsnVisualization`_              | _enum(6) using `TRNLSNVISUALIZATION` list_ |          |           |          | _Describes the visualization mode to be used in the front-end application._      |
...
| `trnSitethemeAccentColor1`                                   | color                                    |          | yes       |          | -                                                                                |
| `trnSitethemeAccentColor2`                                   | color                                    |          | yes       |          | -                                                                                |
| `trnSitethemeAccentColor3`                                   | color                                    |          | yes       |          | -                                                                                |
| `trnSitethemeFavicon`                                        | image                                    |          | yes       |          | -                                                                                |
| `trnThemeNeutralColor`                                       | color                                    |          | yes       |          | -                                                                                |
| `trnTrnsitethemeBaseTitle`                                   | char(100)                                | yes      | yes       |          | -                                                                                |
...
`TrnGitCheckoutService` external object definition
--------------------------------------------------
...
`TrnVideoProxyController` external object definition
----------------------------------------------------
