...
public class TrnCategory extends TrnObject {
  ...
  public List<String> postValidate() {
    ...
    if (getFieldValue("trnCatId.trnCatPath").contains(getFieldValue("trnCatPath")))
      msgs.add(
          Message.formatError("TRN_CAT_LOOP", "A category cannot be referenced as one of its ancestors", "trnCatId"));
  ...
  private int getNextOrder() {
    ...
    String lastOrder = getGrant()
        .simpleQuery("SELECT trn_cat_order FROM trn_category WHERE trn_cat_id" + ref + " ORDER BY trn_cat_order DESC");
